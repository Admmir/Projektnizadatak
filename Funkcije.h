...
fgets(buffer, 200, fptr);
sscanf(buffer, "%d%s%d%s%d%s%d%s%d%s%d%s%d%s%d%s%d%s%d",&p->kviz[0],&trash[0], &p->kviz[1],&trash[0],&p->kviz[2],&trash[0], &p->kviz[3],&trash[0],&p->kviz[4],&trash[0], &p->kviz[5],&trash[0],&p->kviz[6],&trash[0], &p->kviz[7],&trash[0],&p->kviz[8],
...
for(int y=0;y<10;y++){printf("%d ",studenti[i].kviz[y]);}
printf("\n\n");
};}

void meni(){
int opcija=0;
while(opcija<1 || opcija>4){//while petlja u slucaju da izabere nesto deseto
printf("Izaberite kako cete sortirati studente:\n 1: po indexu\n 2: po imenu\n 3: po prezimenu\n 4: po broju bodova iz kvizova\n");
printf("Unesite broj ispred opcije: ");
scanf("%d", &opcija);
if(opcija==1){printf("Izabrali ste opciju 1\n");bsort_index(studenti, 120);odabranosort=1;}
else if(opcija==2){printf("Izabrali ste opciju 2\n");sort_selekcija_ime(studenti, 120);odabranosort=2;}
else if(opcija==3){printf("Izabrali ste opciju 3\n");sort_selekcija_prezime(studenti, 120);odabranosort=3;}
else if(opcija==4){printf("Izabrali ste opciju 4\n");bsort_kviz(studenti, 120);odabranosort=4;}
else{printf("unijeli ste pogresan broj\n");}
...
scanf("%d", &odabir[i]);
if(odabir[i]<1 || odabir[i]>10){printf("Pogresan broj, unesite ponovo");}
}
printf("\n");
brojac--;
odabir[i]=odabir[i]-1;
...
void meni2(){
int opcija=0;
while(opcija<1 || opcija>3){//while petlja u slucaju da izabere nesto deseto
...
int redni;
scanf("%d",&redni);
while(redni>40 || redni<=-2){//while petlja u slucaju da izabere nesto deseto
...
for(int i=0; i<10; i++){printf("%d ",studenti[redni].kviz[i]);}
...
for(int i=0; i<10; i++){printf("%d ",studenti[redni+40].kviz[i]);}
printf("\nUpisite redni broj kviza kojeg zelite izmjeniti: ");
scanf("%d",&index);
while(index>10 || index<0){
        printf("Pogresan broj, ponovite: ");
...
for(int i=0; i<10; i++){printf("%d ",studenti[redni+80].kviz[i]);}
printf("\nUpisite redni broj kviza kojeg zelite izmjeniti: ");
scanf("%d",&index);
while(index>10 || index<0){
        printf("Pogresan broj, ponovite: ");
